...
1. For contribution proposals, create a project spec in the `GOALS/` archive following the naming convention:
...
For current GOAL schema examples, use [`cmd/sgai/GOAL.example.md`](cmd/sgai/GOAL.example.md) or the inline `GOAL.md` example above.
