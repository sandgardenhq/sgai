...
For agent template settings like `mode`, tool permissions, and model overrides, see [Agent template settings (mode, tool permissions, and model)](./docs/reference/agent-templates.md).
