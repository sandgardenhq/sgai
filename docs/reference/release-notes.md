...
```json
{
  ...
  "Breaking Changes": [
    "Refactored the product into a web-only application model with a long-lived per-workspace server process.",
  ...
  "New Features": [
    "Added a guided GOAL authoring experience in the web app to standardize how goals are created and edited.",
  ...
  "Security": [
    "Strengthened coordination safety rules to reduce unintended concurrent actions by non-coordinator agents."
  ]
}
