...
mock.module("@/lib/api", () => ({
  api: {
    workspaces: {
      ...
      openEditorProjectManagement: mock(() => Promise.resolve({ opened: true })),
      steer: mock(() => Promise.resolve({ success: true })),
      ...
      getGoal: mock(() => Promise.resolve({ content: "" })),
      updateGoal: mock(() => Promise.resolve({ success: true })),
    },
    agents: {
      list: mockAgentsList,
    },
