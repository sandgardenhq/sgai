...
1. Read `GOAL.md` and this file before doing anything else.
2. Record important information as soon as it is discovered.
3. Keep entries small and scannable. Prefer bullets.
4. Include evidence (file paths, command outputs, links) when possible.
5. When something changes, append a new entry instead of rewriting history.
