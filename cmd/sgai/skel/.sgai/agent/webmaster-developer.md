...
**You do NOT build:**
- Interactive web applications (use htmx-picocss)
...
Return your implementation summary to the caller. Include files changed, tests run, screenshots captured, verification status, blockers, and any specific review scope the wrapper should pass to `webmaster-reviewer`.
